...
for i, (score, k, vid, preview) in enumerate(results[:8], 1):
    print(f"\n--- test #{i} ---")
...
#Trouver
salaire_encrypte =[81530476374664351124876242644701327168836407987,
...
print("\nDECRYPTED SALAIRES :")
for chiffre in salaire_encrypte:


    temp_salaire = rsa_decrypt(
        chiffre,
        d_2,
        n_salaire
    )
    ...
    salaire_decrypte.append(temp_salaire)


    print(f"Salaire{len(salaire_decrypte)-1} = {temp_salaire}")
